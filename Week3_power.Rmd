...
pdf(file = "Week3_Mean_daily_power.pdf",   
...
```{r}
# The dimensions of the cube are the Power stations and the dimension of date time.
data_cube_2_1<- with(A,cbind( CPLE=Net.generation.2, FPL=Net.generation.4,ISNE= Net.generation.5,
...
temp_2<-temp_2_1[,colnames(temp_2_1)!="Time"]
...
pdf(file = "Week3_Minute_power_demand_1.pdf",   
    width = 8, # The width of the plot in inches
    height = 5) # The height of the plot in inches
# create an empty plot
...
pdf(file = "Week3_Minute_power_demand_2.pdf",   
    width = 8, # The width of the plot in inches
    height = 5) # The height of the plot in inches
